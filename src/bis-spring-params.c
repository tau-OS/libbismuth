...
G_DEFINE_BOXED_TYPE (BisSpringParams, bis_spring_params,
                     bis_spring_params_ref, bis_spring_params_unref)
 ...
 */
BisSpringParams *
bis_spring_params_new (double damping_ratio,
                       double mass,
                       double stiffness)
{
  ...
  return bis_spring_params_new_full (damping, mass, stiffness);
}
 ...
 */
BisSpringParams *
bis_spring_params_ref (BisSpringParams *self)
{
 ...
 */
void
bis_spring_params_unref (BisSpringParams *self)
{
 ...
 */
double
bis_spring_params_get_damping (BisSpringParams *self)
{
...
/**
 * bis_spring_params_get_damping_ratio:
 * @self: spring params
 *
 ...
 */
double
bis_spring_params_get_damping_ratio (BisSpringParams *self)
{
 ...
 */
double
bis_spring_params_get_mass (BisSpringParams *self)
{
  g_return_val_if_fail (self != NULL, 0.0);
...
/**
 * bis_spring_params_get_stiffness:
 * @self: spring params
 *
 ...
 */
double
bis_spring_params_get_stiffness (BisSpringParams *self)
{
  g_return_val_if_fail (self != NULL, 0.0);
