...
G_DEFINE_FINAL_TYPE (BisShadowHelper, bis_shadow_helper, G_TYPE_OBJECT);
...
static void
bis_shadow_helper_constructed (GObject *object)
{
  ...
  G_OBJECT_CLASS (bis_shadow_helper_parent_class)->constructed (object);
}

static void
bis_shadow_helper_dispose (GObject *object)
{
  BisShadowHelper *self = BIS_SHADOW_HELPER (object);
  ...
  G_OBJECT_CLASS (bis_shadow_helper_parent_class)->dispose (object);
}

static void
bis_shadow_helper_get_property (GObject    *object,
                                guint       prop_id,
                                GValue     *value,
                                GParamSpec *pspec)
{
...
static void
bis_shadow_helper_set_property (GObject      *object,
                                guint         prop_id,
                                const GValue *value,
                                GParamSpec   *pspec)
{
...
static void
bis_shadow_helper_class_init (BisShadowHelperClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->constructed = bis_shadow_helper_constructed;
  object_class->dispose = bis_shadow_helper_dispose;
  object_class->get_property = bis_shadow_helper_get_property;
  object_class->set_property = bis_shadow_helper_set_property;

  /**
   * BisShadowHelper:widget:
   *
...
static void
bis_shadow_helper_init (BisShadowHelper *self)
{
}

/**
 * bis_shadow_helper_new:
 *
 * Creates a new `BisShadowHelper`.
 *
 * Returns: the newly created `BisShadowHelper`
 *
 * Since: 1.0
 */
BisShadowHelper *
bis_shadow_helper_new (GtkWidget *widget)
{
  return g_object_new (BIS_TYPE_SHADOW_HELPER,
                       "widget", widget,
                       NULL);
}

static void
set_style_classes (BisShadowHelper *self,
...
void
bis_shadow_helper_size_allocate (BisShadowHelper *self,
                                 int              width,
                                 int              height,
                                 int              baseline,
                                 int              x,
...
void
bis_shadow_helper_snapshot (BisShadowHelper *self,
