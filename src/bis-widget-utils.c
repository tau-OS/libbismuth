...
gboolean
bis_widget_focus_child (GtkWidget        *widget,
                        GtkDirectionType  direction)
{
...
gboolean
bis_widget_grab_focus_self (GtkWidget *widget)
{
...
gboolean
bis_widget_grab_focus_child (GtkWidget *widget)
{
  GtkWidget *child;
...
void
bis_widget_compute_expand (GtkWidget *widget,
                           gboolean  *hexpand_p,
                           gboolean  *vexpand_p)
{
  GtkWidget *child;
...
void
bis_widget_compute_expand_horizontal_only (GtkWidget *widget,
                                           gboolean  *hexpand_p,
                                           gboolean  *vexpand_p)
{
  GtkWidget *child;
...
GtkSizeRequestMode
bis_widget_get_request_mode (GtkWidget *widget)
{
  GtkWidget *child;
  int wfh = 0, hfw = 0;
...
void
bis_widget_get_style_color (GtkWidget *widget,
                            GdkRGBA   *rgba)
{
...
gboolean
bis_widget_lookup_color (GtkWidget  *widget,
                         const char *name,
                         GdkRGBA    *rgba)
{
